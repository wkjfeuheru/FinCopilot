...
export FINH_PATHS_USAGE_DB="$DATA_DIR/state/usage.db"
export FINH_PATHS_COMPUTE_JOBS_DB="$DATA_DIR/state/compute_jobs.db"
export FINH_PATHS_COMPUTE_PACKAGES_DIR="$DATA_DIR/state/compute_packages"
